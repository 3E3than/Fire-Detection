    	    ...
    	    <div className="mt-16 px-12 pb-12">
    	        ...
    	        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
    	            <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-6 hover:scale-105 transition-all duration-300 text-center">
    	                <div className="w-24 h-24 bg-gradient-to-br from-orange-100 to-red-100 rounded-full mx-auto mb-4 flex items-center justify-center">
    	                    <span className="material-symbols-outlined text-4xl text-orange-500">person</span>
    	                </div>
    	                <h4 className="text-xl font-bold">Amrit N. Auji</h4>
    	                <p className="text-orange-600">AI & Backend Developer</p>
    	            </div>
    	            <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-6 hover:scale-105 transition-all duration-300 text-center">
    	                <div className="w-24 h-24 bg-gradient-to-br from-orange-100 to-red-100 rounded-full mx-auto mb-4 flex items-center justify-center">
    	                    <span className="material-symbols-outlined text-4xl text-orange-500">person</span>
    	            ...
    	            <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-6 hover:scale-105 transition-all duration-300 text-center">
    	                ...
    	                <p className="text-orange-600">UI/UX Designer</p>
    	            </div>
    	            <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-6 hover:scale-105 transition-all duration-300 text-center">
    	                <div className="w-24 h-24 bg-gradient-to-br from-orange-100 to-red-100 rounded-full mx-auto mb-4 flex items-center justify-center">
    	                    <span className="material-symbols-outlined text-4xl text-orange-500">person</span>
    	                </div>
    	                <h4 className="text-xl font-bold">Team Member 4</h4>
